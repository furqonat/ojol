...
import 'auth_daftar_motor_model.dart';
export 'auth_daftar_motor_model.dart';

class AuthDaftarMotorWidget extends StatefulWidget {
  const AuthDaftarMotorWidget({Key? key}) : super(key: key);

  @override
  _AuthDaftarMotorWidgetState createState() => _AuthDaftarMotorWidgetState();
}

class _AuthDaftarMotorWidgetState extends State<AuthDaftarMotorWidget> {
  late AuthDaftarMotorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthDaftarMotorModel());
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Jenis kendaraan ( honda, yamaha, suzuki )',
                          hintStyle: FlutterFlowTheme.of(context).labelMedium,
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: FlutterFlowTheme.of(context).alternate,
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Merk kendaraan ( Beat, supra, dll )',
                          hintStyle: FlutterFlowTheme.of(context).labelMedium,
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: FlutterFlowTheme.of(context).alternate,
