...
import 'auth_daftar_mobil_model.dart';
export 'auth_daftar_mobil_model.dart';

class AuthDaftarMobilWidget extends StatefulWidget {
  const AuthDaftarMobilWidget({Key? key}) : super(key: key);

  @override
  _AuthDaftarMobilWidgetState createState() => _AuthDaftarMobilWidgetState();
}

class _AuthDaftarMobilWidgetState extends State<AuthDaftarMobilWidget> {
  late AuthDaftarMobilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthDaftarMobilModel());
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText:
                              'Jenis kendaraan ( honda, toyota, daihatsu)',
                          hintStyle: FlutterFlowTheme.of(context).labelMedium,
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: FlutterFlowTheme.of(context).alternate,
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Merk kendaraan ( Xenia, avanza, brio )',
                          hintStyle: FlutterFlowTheme.of(context).labelMedium,
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: FlutterFlowTheme.of(context).alternate,
