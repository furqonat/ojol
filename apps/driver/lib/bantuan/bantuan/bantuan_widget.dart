...
class _BantuanWidgetState extends State<BantuanWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BantuanModel());
  }
