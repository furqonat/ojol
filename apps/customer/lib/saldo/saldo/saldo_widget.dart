...
class _SaldoWidgetState extends State<SaldoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SaldoModel());
  }
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: wrapWithModel(
                            model: _model.saldoDanaPotonganMartModel,
                            updateCallback: () => setState(() {}),
                            child: SaldoDanaPotonganMartWidget(),
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: wrapWithModel(
                            model: _model.saldoDanaPotonganFoodModel,
                            updateCallback: () => setState(() {}),
                            child: SaldoDanaPotonganFoodWidget(),
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: wrapWithModel(
                            model: _model.saldoDanaPotonganDelivModel,
                            updateCallback: () => setState(() {}),
                            child: SaldoDanaPotonganDelivWidget(),
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: wrapWithModel(
                            model: _model.saldoDanaPotonganRideModel,
                            updateCallback: () => setState(() {}),
                            child: SaldoDanaPotonganRideWidget(),
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: wrapWithModel(
                            model: _model.saldoDanaPotonganCarModel,
                            updateCallback: () => setState(() {}),
                            child: SaldoDanaPotonganCarWidget(),
                          ),
                        ),
                      ),
                    ],
