...
class _Chat1WidgetState extends State<Chat1Widget> {
  ...
  void initState() {
    ...
    _model.pencarianController ??= TextEditingController();
    _model.pencarianFocusNode ??= FocusNode();
  }
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          8.0, 0.0, 8.0, 0.0),
                                      child: TextFormField(
                                        controller: _model.pencarianController,
                                        focusNode: _model.pencarianFocusNode,
                                        autofocus: true,
                                        obscureText: false,
