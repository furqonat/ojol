...
import 'halaman_utama_model.dart';

export 'halaman_utama_model.dart';

class HalamanUtamaWidget extends StatefulWidget {
  const HalamanUtamaWidget({super.key});

  @override
  createState() => _HalamanUtamaWidgetState();
}

class _HalamanUtamaWidgetState extends State<HalamanUtamaWidget> {
  late HalamanUtamaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HalamanUtamaModel());
  }
                                                          ...
                                                          Container(
                                                            ...
                                                            decoration:
                                                              ...
                                                              image:
                                                                ...
                                                                image:
                                                                    Image.asset(
                                                                  'assets/images/1696044585451.png',
                                                                ).image,
                                                              ),
                                                            ),
                                                          ),
                                        ...
                                        child: CarouselSlider(
                                          items: [
                                            ClipRRect(
                                              ...
                                              child: Image.asset(
                                                'assets/images/2023-05-05_(2).jpg',
                                                width: 300.0,
                                                height: 200.0,
                                                fit: BoxFit.cover,
                                              ),
                                            ...
                                            ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(8.0),
                                              child: Image.asset(
                                                'assets/images/2023-05-05_(5).png',
                                                width: 300.0,
                                                height: 200.0,
                                                fit: BoxFit.cover,
                                              ),
