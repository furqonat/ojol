...
class PageMart extends GetView<ControllerMart>{
  const PageMart({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          InkWell(
              onTap: ()=> Get.toNamed(Routes.history_mart),
              child: SizedBox(
                width: 55,
                height: 55,
                child: Card(
                  ...
                  child: const Center(
                    child: Icon(Icons.list_alt_rounded, size: 24, color: Colors.white),
                  ),
                ),
              )
          )
            ...
            Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: ()=> Get.toNamed(Routes.mart_menu),
                      child: Padding(
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: const Image(
                                    ...
                                    height: 80,
                                    fit: BoxFit.cover,
                                    image: AssetImage('assets/images/minimarket.png')
                                ),
                              ),
                            ),
                            Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    const Icon(Icons.star_rounded, color: Colors.deepOrangeAccent),
                                    Container(
                                      width: 1,
                                      height: 20,
