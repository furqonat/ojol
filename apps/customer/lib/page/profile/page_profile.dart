                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Column(
                        ...
                        children: <Widget>[
                          Text(
                            controller.controllerUser.user.value.name ?? "user name",
                          ...
                          Text(
                            controller.controllerUser.user.value.email ?? "user@email.com",
                            style: GoogleFonts.readexPro(
                                fontSize: 12,
                                color: Colors.white,
                      ...
                      ElevatedButton(
                          onPressed: ()=> Get.toNamed(Routes.edit_profile, arguments: {
                            'name' : controller.controllerUser.user.value.name ?? "",
                            'email' : controller.controllerUser.user.value.email,
                            'phone' : controller.controllerUser.user.value.phone,
                            'avatar' : controller.controllerUser.user.value.avatar ?? "",
                          }),
                          style: ElevatedButton.styleFrom(
                              elevation: 0,
                              fixedSize: Size(Get.width * 0.3, Get.height * 0.04),
