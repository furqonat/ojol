          ...
          builder: (context, transSnapshot) {
            if (transSnapshot.data?.driverId != null) {
              ...
              return StreamBuilder<List<Driver>>(
                stream: controller.listenLocation(transSnapshot.data?.driverId),
                      ...
                      children: <Widget>[
                        Obx(() => GoogleMap(
                                ...
                                polylines: {
                                  Polyline(
                                      polylineId:
                                          const PolylineId("Rute Perjalanan"),
                                              ...
                                              child: ElevatedButton(
                                                  ...
                                                  style:
                                                    ...
                                                    backgroundColor: transSnapshot
                                                        ...
                                                        ? Colors.red
                                                        : Colors.orange,
                                                    disabledBackgroundColor: transSnapshot
                                                                    .data
                                                                    ?.status ==
                                                                "OTW" ||
                                                            transSnapshot.data
                                                            ...
                                                            : transSnapshot.data
                                                                ...
                                                                : transSnapshot
                                                                    ...
                                                                    : transSnapshot.data?.status ==
                                                                            "WAITING_MERCHANT"
                                                                        ? "Menunggu toko"
                                                                        : transSnapshot.data?.status == "DRIVER_CLOSE" ||
                                                                                transSnapshot.data?.status == "CANCELED" ||
                                                                                transSnapshot.data?.status == "EXPIRED"
                                                                            ? "Kembali"
                                                                            : "Batalkan",
                                                    style:
