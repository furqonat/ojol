                ...
                child: SingleChildScrollView(
                  ...
                  child: Obx(() => Column(
                    ...
                    children: <Widget>[
                      ...
                      Visibility(
                        visible: controller.requestType.value == 'delivery'
                            ? true
                            : false,
                        child: Padding(
                          padding: const EdgeInsets.fromLTRB(25, 5, 25, 0),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            GestureDetector(
                              onTap: ()=> log(controller.requestType.value),
                              child: Column(
                                children: <Widget>[
                                  Icon(
                            ...
                            Visibility(
                              visible: controller.requestType.value == 'food' || controller.requestType.value == 'mart'
                                  ? true
                                  : false,
                              child: Container(
                                width: 1,
                            ...
                            Visibility(
                              ...
                              child: Column(
                                children: <Widget>[
                                  Icon(
                                    Icons.list_rounded, size: 30, color: Colors.grey.shade500,
                                  ),
                                  Text(
                                    'Pesanan',
                                    style: GoogleFonts.readexPro(
                        ...
                        child: Padding(
                          ...
                          child: ElevatedButton(
                              onPressed: (){
                                ...
                                }else if(controller.requestType.value == 'delivery'){
                                  Get.offAndToNamed(Routes.delivery_finish);
                                }else{
