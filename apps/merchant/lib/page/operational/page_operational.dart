            ...
            child: Obx(() => Row(
              ...
              children: <Widget>[
                    ...
                    RichText(
                        text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                  text: controller.aInput[index]["Jam buka"].value,
                                  style: GoogleFonts.readexPro(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w500,
                                    color: const Color(0xFF3978EF),
                                  ...
                                  recognizer: TapGestureRecognizer()..onTap = () async {
                                    ...
                                    if (selectedTime != null) {
                                      controller.aInput[index]["Jam buka"].value = selectedTime.format(context).toString();
                                    }
                                  }
                              ),
                              const TextSpan(
                              ...
                              TextSpan(
                                  ...
                                  recognizer: TapGestureRecognizer()..onTap = () async {
                                    ...
                                    if (selectedTime != null) {
                                      controller.aInput[index]["Jam tutup"].value = selectedTime.format(context).toString();
                                    }
                                  }
                              ),
                            ]
                ...
                Switch.adaptive(
                  ...
                  onChanged: (value) => controller.aInput[index]['Status'].value = value,
                )
              ],
            )),
          );
