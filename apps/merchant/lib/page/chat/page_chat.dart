...
import 'package:lugo_marchant/page/chat/controller_chat.dart';
      ...
      body: Column(
        ...
        children: <Widget>[
                  ...
                  return snapshot.data!.isNotEmpty
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Column(
                          crossAxisAlignment:
                          snapshot.data?[index].idSender == controller.controllerUser.user.value.id
                              ? CrossAxisAlignment.end
                              : CrossAxisAlignment.start,
                          children: [
                            Container(
                              padding: const EdgeInsets.all(8),
                              margin: EdgeInsets.fromLTRB(8,8, 8,
                                  snapshot.data![index].attachment!.isNotEmpty
                                      ? 0
                                      : 8),
                            ...
                            Visibility(
                                visible: snapshot.data?[index].attachment == '' || snapshot.data?[index].attachment == null
                                    ? false
                                    : true,
                                child: Padding(
                                  padding: const EdgeInsets.all(8),
                                  child: Card(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: snapshot.data?[index].idSender ==
                                          controller.controllerUser.user.value.id
                                          ? const BorderRadius.only(
                                        topLeft: Radius.circular(15),
                                        topRight:Radius.circular(15),
                                        bottomLeft: Radius.circular(15),
                                      ...
                                      child: CachedNetworkImage(
                                        width: Get.width * 0.7,
                                        imageUrl: snapshot.data![index].attachment!,
          ...
          Obx(() => Padding(
            ...
            child: SizedBox(
              width: Get.width,
              height: controller.showAttachment.value == false ? Get.height * 0.085 : Get.height * 0.3,
              child: Card(
                elevation: 0,
