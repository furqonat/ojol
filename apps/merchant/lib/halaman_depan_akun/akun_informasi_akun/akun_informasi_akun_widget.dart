...
import 'akun_informasi_akun_model.dart';
export 'akun_informasi_akun_model.dart';

class AkunInformasiAkunWidget extends StatefulWidget {
  const AkunInformasiAkunWidget({Key? key}) : super(key: key);

  @override
  _AkunInformasiAkunWidgetState createState() =>
      _AkunInformasiAkunWidgetState();
}

class _AkunInformasiAkunWidgetState extends State<AkunInformasiAkunWidget> {
  late AkunInformasiAkunModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AkunInformasiAkunModel());
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(12.0, 0.0, 12.0, 18.0),
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Container(
