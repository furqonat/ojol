...
import 'auth_daftar_mart_model.dart';
export 'auth_daftar_mart_model.dart';

class AuthDaftarMartWidget extends StatefulWidget {
  const AuthDaftarMartWidget({Key? key}) : super(key: key);

  @override
  _AuthDaftarMartWidgetState createState() => _AuthDaftarMartWidgetState();
}

class _AuthDaftarMartWidgetState extends State<AuthDaftarMartWidget> {
  late AuthDaftarMartModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthDaftarMartModel());
