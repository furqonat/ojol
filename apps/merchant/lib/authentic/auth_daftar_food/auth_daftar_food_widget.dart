...
import 'auth_daftar_food_model.dart';
export 'auth_daftar_food_model.dart';

class AuthDaftarFoodWidget extends StatefulWidget {
  const AuthDaftarFoodWidget({Key? key}) : super(key: key);

  @override
  _AuthDaftarFoodWidgetState createState() => _AuthDaftarFoodWidgetState();
}

class _AuthDaftarFoodWidgetState extends State<AuthDaftarFoodWidget> {
  late AuthDaftarFoodModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthDaftarFoodModel());
