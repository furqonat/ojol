...
namespace NodeJS {
  ...
  interface ProcessEnv {
    readonly NEXT_PUBLIC_PROD_BASE_URL: string
    readonly NEXT_PUBLIC_AUTH_BASE_URL: string
    readonly NEXT_PUBLIC_ACCOUNT_BASE_URL: string
    readonly NEXT_PUBLIC_GATE_BASE_URL: string
    readonly NEXT_PUBLIC_DEV_BASE_URL
    readonly NEXTAUTH_URL: string
    readonly NEXT_PUBLIC_GM_API: string
