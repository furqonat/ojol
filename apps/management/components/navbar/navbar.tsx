      ...
      <div className={'container flex flex-row gap-2 items-center'}>
        <div className="drawer visible md:hidden">
          ...
          <div className="drawer-side">
            ...
            ></label>
            <ul className="menu pt-6 gap-4 bg-white">
              <li>
              ...
              <li>
                <Link
                  href={'/registrations'}
                  className={
                    pathname.startsWith('/registrations') ? 'active' : ''
                  }
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <Link
                  href={'/transactions'}
                  className={
                    pathname.startsWith('/transactions') ? 'active' : ''
                  }
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="dropdown dropdown-end">
          ...
          >
            <div className="w-10 rounded-full">
              <img alt="Tailwind CSS Navbar component" src="/lugo.png" />
            </div>
          </label>
          <ul
            tabIndex={0}
